...
public class MxClass {
	...
	public net.fabricmc.modified.extension.mixin.common.data.MxMember getField(String name, String desc) {
		return new net.fabricmc.modified.extension.mixin.common.data.MxMember(this.name, name, desc);
	}

	public net.fabricmc.modified.extension.mixin.common.data.MxMember getMethod(String name, String desc) {

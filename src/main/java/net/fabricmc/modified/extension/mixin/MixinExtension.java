...
package net.fabricmc.modified.extension.mixin;
...
import net.fabricmc.modified.extension.mixin.hard.HardTargetMixinClassVisitor;
import net.fabricmc.modified.extension.mixin.soft.SoftTargetMixinClassVisitor;
import org.objectweb.asm.ClassVisitor;

import net.fabricmc.modified.extension.mixin.common.Logger;
import net.fabricmc.modified.extension.mixin.common.Logger.Level;
import net.fabricmc.modified.extension.mixin.common.data.CommonData;

/**
 * A extension for remapping mixin annotation.
 */
public class MixinExtension implements net.fabricmc.modified.TinyRemapper.Extension {
	...
	@Override
	public void attach(net.fabricmc.modified.TinyRemapper.Builder builder) {

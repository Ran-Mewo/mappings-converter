...
import net.fabricmc.modified.TinyRemapper.Direction;
import net.fabricmc.modified.TinyRemapper.LinkedMethodPropagation;
import net.fabricmc.modified.TinyRemapper.MrjState;
...
import net.fabricmc.modified.api.TrMember.MemberType;
import net.fabricmc.modified.api.TrMethod;

public final class ClassInstance implements TrClass {
	ClassInstance(net.fabricmc.modified.TinyRemapper tr, boolean isInput, InputTag[] inputTags, Path srcFile, byte[] data) {
	...
	void propagate(MemberType type, String originatingCls, String idSrc, String nameDst,
		...
		if (member != null) {
			...
			if (first
				...
				MemberInstance bridgeTarget = net.fabricmc.modified.BridgeHandler.getTarget(member);

...
package net.fabricmc.modified.api;
...
public interface TrClass {
	...
	net.fabricmc.modified.api.TrField getField(String name, String desc);
	TrMethod getMethod(String name, String desc);

	Collection<? extends net.fabricmc.modified.api.TrField> getFields();
	Collection<? extends TrMethod> getMethods();
	Collection<? extends TrMember> getMembers();

	Collection<net.fabricmc.modified.api.TrField> getFields(String name, String desc, boolean isDescPrefix, Predicate<net.fabricmc.modified.api.TrField> filter, Collection<net.fabricmc.modified.api.TrField> out);
	...
	net.fabricmc.modified.api.TrField resolveField(String name, String desc);
	 ...
	 */
	Collection<net.fabricmc.modified.api.TrField> resolveFields(String name, String desc, boolean isDescPrefix, Predicate<net.fabricmc.modified.api.TrField> filter, Collection<TrField> out);

...
public final class PackageAccessChecker {
	...
	public static void checkValue(String accessingClass, Object value, String source, AsmRemapper remapper) {
		if (value instanceof Type) {
			...
			checkMember(accessingClass, handle.getOwner(), handle.getName(), handle.getDesc(), net.fabricmc.modified.api.TrMember.MemberType.METHOD, source, remapper);
	 ...
	 */
	public static void checkMember(String accessingOwner, String owner, String name, String desc, net.fabricmc.modified.api.TrMember.MemberType type, String source, AsmRemapper remapper) {
		...
		if (type == net.fabricmc.modified.api.TrMember.MemberType.FIELD) {

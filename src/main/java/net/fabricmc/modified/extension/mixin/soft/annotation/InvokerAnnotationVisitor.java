...
public class InvokerAnnotationVisitor extends FirstPassAnnotationVisitor {
	...
	public InvokerAnnotationVisitor(net.fabricmc.modified.extension.mixin.common.data.CommonData data, AnnotationVisitor delegate, net.fabricmc.modified.extension.mixin.common.data.MxMember method, boolean remap, List<String> targets) {

...
package net.fabricmc.modified.extension.mixin.soft.data;

import java.util.Objects;

import net.fabricmc.modified.api.TrMember;
import net.fabricmc.modified.extension.mixin.common.StringUtility;
...
public final class MemberInfo {
	...
	public TrMember.MemberType getType() {
		...
		return net.fabricmc.modified.extension.mixin.common.StringUtility.isMethodDesc(desc) ? TrMember.MemberType.METHOD : TrMember.MemberType.FIELD;
	}
	...
	public static MemberInfo parse(String str) {
		...
		if ((sep = str.indexOf(';')) >= 0) {
			owner = net.fabricmc.modified.extension.mixin.common.StringUtility.classDescToName(str.substring(0, sep + 1));

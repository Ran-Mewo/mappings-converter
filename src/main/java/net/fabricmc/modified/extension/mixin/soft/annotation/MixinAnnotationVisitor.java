...
package net.fabricmc.modified.extension.mixin.soft.annotation;
...
public class MixinAnnotationVisitor extends FirstPassAnnotationVisitor {
	...
	public MixinAnnotationVisitor(net.fabricmc.modified.extension.mixin.common.data.CommonData data, AnnotationVisitor delegate, AtomicBoolean remapOut, List<String> targetsOut) {
	...
	private static class MixinSecondPassAnnotationVisitor extends AnnotationVisitor {
		...
		public AnnotationVisitor visitArray(String name) {
			...
			if (name.equals(net.fabricmc.modified.extension.mixin.common.data.AnnotationElement.TARGETS)) {
				return new AnnotationVisitor(net.fabricmc.modified.extension.mixin.common.data.Constant.ASM_VERSION, visitor) {
					@Override

...
public class MxMember {
	...
	public net.fabricmc.modified.api.TrMember.MemberType getType() {
	...
	public net.fabricmc.modified.api.TrMember asTrMember(net.fabricmc.modified.extension.mixin.common.ResolveUtility resolver) {
